...
public class Tenant extends User {
    ...
    public Tenant(int id, String fullname, String password, String email, String phoneNumber){
        super(idCount,"username",fullname,password,email,"Active","Tenant",phoneNumber);
        
    }

    public static Tenant createTenant(String fullname, String password, String email, String phoneNumber){
        int id = ++idCount;
        Database.writeData("Tenant", Arrays.asList(Integer.toString(idCount), fullname, "username", password, email, "Active", "Tenant", phoneNumber));
